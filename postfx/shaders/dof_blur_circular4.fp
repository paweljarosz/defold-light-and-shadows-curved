...
// 4-direction circular-ish gather: samples +/- X/Y plus an inner ring; CoC magnitude scales radius for bokeh-like blur.
void main()
{
    ...
    gl_FragColor = vec4(color / max(weight, 0.0001), center.a);
}
